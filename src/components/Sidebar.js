...
import { faBook, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faSignOutAlt, faTable,faBullhorn,faUsers, faTimes,faCoins,faShare, faCalendarAlt, faMapPin, faInbox, faRocket, faTruck, faFlag, faList } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="YO YO Event" link={Routes.Presentation.path} image={ReactHero} />
              ...
              <NavItem title="To-do" icon={faList} link={""} />
              <NavItem title="Team" icon={faUsers} link={Routes.Users.path} />
